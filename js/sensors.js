/**
 * sensors.js
 * Common format / sensor database (bilingual, Chinese and English)
 *
 * Each entry contains:
 ...
 *   w         Sensor width (mm)
 *   h         Sensor height (mm)
 *   coc       Default circle of confusion diameter (mm)
 *   pixels    Typical pixel count (megapixels)
 *   group     Chinese group
 *   groupEn   English group
 */
...
// Full frame diagonal (used to compute crop factor)
...
/**
 * Compute the circle of confusion diameter (mm) for loose/normal/strict presets.
 *   loose  : diagonal / 1000 - deeper DoF
 *   normal : diagonal / 1500 - standard
 *   strict : diagonal / 2000 - shallower DoF
 */
